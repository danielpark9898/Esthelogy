# Django settings for Esthelogy project.
import os
...
SECRET_KEY = '_bva%ybk3_xve-@gtqd7r0a_uq@cmb4aj#e2su+^p^v97!jjmm'
...
WSGI_APPLICATION = 'Esthelogy.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = (
    'Esthelogy.migrations',
    'Esthelogy.tests',
    'Esthelogy.local_settings',
    'opal.migrations',
    'opal.tests',
    'opal.wsgi',
)
...
DEFAULT_DOMAIN = 'http://Esthelogy.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'Esthelogy'
